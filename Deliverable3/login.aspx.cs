...
namespace Deliverable3
{
    public partial class login : System.Web.UI.Page
    {
        ...
        protected void ButtonLogin_Click(object sender, EventArgs e)
        {
            ...
            conn.Open();
            /* SQL Statement */
            string checkuser = "select count(*) from [User] where deptName='" + DropDownListDept.Text + "'";
            ...
            if (temp == 1)
            {
                string page = "";
                conn.Open();
                string checkpassword = "Select password from [User] where deptName='" + DropDownListDept.Text + "'";

<%@ Page Language="C#" MasterPageFile="Site.master" AutoEventWireup="true" CodeBehind="login.aspx.cs" Inherits="Deliverable3.login" %>
...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="MainContent">
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
        ...
        SelectCommand="SELECT [deptName] FROM [User] ORDER BY [deptName]">
    </asp:SqlDataSource>
    <div class="canister">
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <asp:DropDownList ID="DropDownListDept" runat="server" 
                        ...
                        DataValueField="deptName" class="form-control text-center select">
                    </asp:DropDownList>
                </div>
                <div class="text-center col-md-12">
